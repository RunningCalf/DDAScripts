...
if %isMounted%=="false" subst Z: E:\views\cp2_view_DDADeltaRel

cd /d Z:\BuildScripts
echo Waiting for \\was-cc2-tech\cm_bld1\%BuildNum%\BuildProgress\binaries.RELEASE.64.txt
WaitAFile.exe \\was-cc2-tech\cm_bld1\%BuildNum%\BuildProgress\binaries.RELEASE.64.txt
echo Found \\was-cc2-tech\cm_bld1\%BuildNum%\BuildProgress\binaries.RELEASE.64.txt
cleartool update Z:\BuildScripts\conspecs
cleartool setcs -over Z:\BuildScripts\conspecs\%BuildNum%_cs.txt
xcopy /I /Y /E /V /F \\was-cc2-tech\cm_bld1\%BuildNum%\RELEASE\* Z:\
cd /d Z:\3rdParty
CALL Register.Bat
cd /d Z:\BuildScripts
